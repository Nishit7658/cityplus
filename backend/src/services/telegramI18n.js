...
const I18N = {
  en: {
    ...
    wards: [
      { id: 1, label: '📍 Ward 1 (Sayajigunj)', name: 'Ward 1 — Sayajigunj' },
      { id: 2, label: '📍 Ward 2 (Akota)', name: 'Ward 2 — Akota' },
      { id: 3, label: '📍 Ward 3 (Raopura)', name: 'Ward 3 — Raopura' },
      { id: 4, label: '📍 Ward 4 (Karelibaug)', name: 'Ward 4 — Karelibaug' },
      { id: 5, label: '📍 Ward 5 (Fatehgunj)', name: 'Ward 5 — Fatehgunj' },
      { id: 6, label: '📍 Ward 6 (Manjalpur)', name: 'Ward 6 — Manjalpur' },
      { id: 7, label: '📍 Ward 7 (Makarpura)', name: 'Ward 7 — Makarpura' },
      { id: 8, label: '📍 Ward 8 (Gotri)', name: 'Ward 8 — Gotri' },
      { id: 9, label: '📍 Ward 9 (Gorwa)', name: 'Ward 9 — Gorwa' },
      { id: 10, label: '📍 Ward 10 (Waghodia)', name: 'Ward 10 — Waghodia' },
    ],
  ...
  gu: {
    ...
    wards: [
      { id: 1, label: '📍 વોર્ડ ૧ (સયાજીગંજ)', name: 'વોર્ડ ૧ — સયાજીગંજ' },
      { id: 2, label: '📍 વોર્ડ ૨ (અકોટા)', name: 'વોર્ડ ૨ — અકોટા' },
      { id: 3, label: '📍 વોર્ડ ૩ (રાવપુરા)', name: 'વોર્ડ ૩ — રાવપુરા' },
      { id: 4, label: '📍 વોર્ડ ૪ (કારેલીબાગ)', name: 'વોર્ડ ૪ — કારેલીબાગ' },
      { id: 5, label: '📍 વોર્ડ ૫ (ફતેહગંજ)', name: 'વોર્ડ ૫ — ફતેહગંજ' },
      { id: 6, label: '📍 વોર્ડ ૬ (માંજલપુર)', name: 'વોર્ડ ૬ — માંજલપુર' },
      { id: 7, label: '📍 વોર્ડ ૭ (મકરપુરા)', name: 'વોર્ડ ૭ — મકરપુરા' },
      { id: 8, label: '📍 વોર્ડ ૮ (ગોત્રી)', name: 'વોર્ડ ૮ — ગોત્રી' },
      { id: 9, label: '📍 વોર્ડ ૯ (ગોરવા)', name: 'વોર્ડ ૯ — ગોરવા' },
      { id: 10, label: '📍 વોર્ડ ૧૦ (વાઘોડિયા)', name: 'વોર્ડ ૧૦ — વાઘોડિયા' },
    ],
    location_prompt: (categoryTitle) =>
  ...
  hi: {
    ...
    wards: [
      { id: 1, label: '📍 वार्ड १ (सयाजीगंज)', name: 'वार्ड १ — सयाजीगंज' },
      { id: 2, label: '📍 वार्ड २ (अकोटा)', name: 'वार्ड २ — अकोटा' },
      { id: 3, label: '📍 वार्ड ३ (रावपुरा)', name: 'वार्ड ३ — रावपुरा' },
      { id: 4, label: '📍 वार्ड ४ (कारेलीबाग)', name: 'वार्ड ४ — कारेलीबाग' },
      { id: 5, label: '📍 वार्ड ५ (फतेहगंज)', name: 'वार्ड ५ — फतेहगंज' },
      { id: 6, label: '📍 वार्ड ६ (मांजलपुर)', name: 'वार्ड ६ — मांजलपुर' },
      { id: 7, label: '📍 वार्ड ७ (मकरपुरा)', name: 'वार्ड ७ — मकरपुरा' },
      { id: 8, label: '📍 वार्ड ८ (गोत्री)', name: 'वार्ड ८ — गोत्री' },
      { id: 9, label: '📍 वार्ड ९ (गोरवा)', name: 'वार्ड ९ — गोरवा' },
      { id: 10, label: '📍 वार्ड १० (वाघोडिया)', name: 'वार्ड १० — वाघोडिया' },
    ],
    location_prompt: (categoryTitle) =>
